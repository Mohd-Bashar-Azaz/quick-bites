...
export default function StickyCartBar() {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div
          className="w-full max-w-[430px] mx-4 rounded-2xl px-4 py-3 flex items-center justify-between"
          style={{
            background: '#242424',
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-lg font-bold text-[#FF6B35]">₹{cartTotal}</p>
            </div>
          </div>
          <motion.button
            whileTap={{ scale: 0.97 }}
            ...
            style={{ boxShadow: '0 4px 16px rgba(255, 107, 53, 0.35)' }}
          >
            View Cart
            <span>→</span>
          </motion.button>
