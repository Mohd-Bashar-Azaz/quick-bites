...
export default function HomeScreen() {
  ...
  const trendingItems = menuItems.filter(m => m.isTrending).slice(0, 5);
  const fastItems = menuItems.filter(m => m.isFast).slice(0, 6);
  ...
  return (
    <div className="h-full overflow-y-auto no-scrollbar bg-[#0F0F0F] relative">
      <FloatingParticles />
